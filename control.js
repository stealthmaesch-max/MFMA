...
async function createEvent(){
 ...
 const eventFormat=championshipEvent?.eventFormat||$("new-event-format").value||"regular",pointsEvent=eventFormat==="qualifying"?false:championshipEvent?championshipEvent.pointsEvent!==false:$("new-event-points").value==="points";
