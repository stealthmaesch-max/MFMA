...
import { LEGACY_VEHICLES, applyStandingsAdjustments, normalizeMraNumber, normalizeName, currentSeasonId, rebuildStandings } from "./competition-model.js?v=81";
...
function teamDrivers(teamId){return Object.entries(competition.drivers||{}).filter(([,driver])=>driver.status==="approved"&&driver.teamId===teamId).sort((a,b)=>a[1].name.localeCompare(b[1].name))}
