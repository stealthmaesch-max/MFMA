...
assert.match(control,/function installGripControls\(\)/);assert.match(control,/\["rain","Rain \/ Water"\]/);assert.match(control,/\["debris","Loose Debris"\]/);assert.match(control,/activeFlag:"grip-deterioration"/);
